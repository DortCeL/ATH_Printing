	...
	return (
		<section id='works' className='py-20 md:py-28 bg-surface-deep text-foreground'>
			<div className='container'>
				<Reveal variant='fade' className='text-center max-w-2xl mx-auto mb-16'>
				...
				<Reveal variant='left' delay={80} duration={800}>
				...
				<div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-6'>
					{rest.map((item, i) => (
						<Reveal key={i} variant='up' delay={120 + i * 90}>
							<div className='rounded-2xl border border-white/10 bg-white/[0.04] p-6 hover:bg-white/[0.07] transition-colors flex flex-col h-full'>
				...
				<Reveal variant='up' delay={200} className='text-center mt-12'>
