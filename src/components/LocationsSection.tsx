	...
	return (
		<section id='locations' className='relative py-16 sm:py-20 md:py-28 bg-surface-deep overflow-hidden'>
			...
			<div className='container relative'>
				<Reveal variant='down' className='text-center max-w-2xl mx-auto mb-10 md:mb-16'>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 md:gap-6 max-w-6xl mx-auto'>
					{loc.shops.map((shop, i) => (
						<Reveal key={i} variant={cardVariants[i % cardVariants.length]} delay={i * 110}>
							<div className='group bg-card/80 rounded-2xl border border-white/10 shadow-lg shadow-black/20 overflow-hidden flex flex-col hover:border-accent/40 transition-colors h-full'>
